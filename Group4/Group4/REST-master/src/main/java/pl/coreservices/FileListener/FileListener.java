...
public class FileListener {
    ...
    public Path watchedDirectory = Paths.get("C:\\test");
    private IMap<String, Statistic> database;

    private ConfigurableApplicationContext contex;

    public FileListener(ConfigurableApplicationContext contex, IMap<String, Statistic> database) {
        this.contex = contex;
        this.database = database;
    }

    public void run() throws IOException, InterruptedException {
        FileReaderClass read = new FileReaderClass(contex, database);
